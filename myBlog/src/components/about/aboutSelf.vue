    ...
    <full-page :options="options" id="fullpage" ref="fullpage">
      <div class="section item1">
          <div class="section-one">
              <p class="text_one">Hello,I'm ZJR</p>
              <p class="text_two">Life can't be twice, but many people are not good at one</p>
              <p class="text_three">我是一名前端开发工程师</p>
          </div>
      </div>
...
<style scoped>
@import "../../assets/css/about/aboutself.css";
</style>